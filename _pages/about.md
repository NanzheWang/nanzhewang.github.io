...
Subsurface flow modeling is inherently uncertain due to the complexity of geological systems and limited observational data. This uncertainty can lead to inaccurate forecasts, suboptimal decision-making, and increased operational risks. My work addresses these challenges by integrating **numerical simulation, data-driven and AI-powered models, statistical and optimization methods, domain knowledge, and diverse data sources**. Specifically, I develop methodologies to quantify and reduce uncertainties in subsurface flow modeling, monitor subsurface behaviors, and forecast future responses. These efforts aim to provide actionable insights for optimizing subsurface operations, mitigating risks, and enhancing the safety and efficiency of subsurface energy/resource development.
